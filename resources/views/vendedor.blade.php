        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="col-lg-4">
                        {!! Form::open(array('url' => 'vendedor','method' => 'post', 'enctype' =>'multipart/form-data')) !!}
                        {!! csrf_field() !!}
                        {{--<form class="form-horizontal" role="form">--}}
                        <h3 class="form-section">Cargar Nuevo Vendedor</h3>
                        ...
                        <div class="row">
                            <div class="form-group{{ $errors->has('ven_email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    @if ($errors->has('ven_email'))
                                        <span class="help-block">
                                                <strong>{{ $errors->first('ven_email') }}</strong>
                                            </span>
                                    @endif
                                </div>
                            </div>
