            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        $contactoss = \CRMComercial\Entities\ContactoCliPot::where('cpc_prospecto', '=', $prospCliPot->cpc_prospecto)->orderBy('cpc_codigo', 'desc')->first();
                        ...
                        <div class="square-widget">
                            <div class="widget-container">
                                ...
                                {!! Form::model($prospCliPot, array('route' => ['form_clipotenciales.update', $prospCliPot->cpp_codigo], 'method' => 'PUT',  'name' => 'form', 'id' => 'default', 'enctype' =>'multipart/form-data')) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('cpp_codigo', null , ['class' => 'form-control','placeholder' => 'Código Prospecto']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="cliente">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('con_nombre', $prospCliPot->cpp_nombre, ['class' => 'form-control']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('cpp_conces', null, ['class' => 'form-control','placeholder' => 'Código Empresa']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('localidad', $prospCliPot->cpp_localinombre, ['class' => 'form-control','placeholder' => 'Localidad', 'id' => 'localidad']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7" id="div-marca">
                                                    @if($prospCliPot->cpp_tipomarca == 1)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('cpc_sistemeva[]', $sistemass, null, ['multiple' => 'multiple', 'class' => 'form-control margin','id' => 'chosen-select']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-lg-7">
                                                    {!! Form::date('cpc_fechademo', $prospCliPot->cpc_fechademo == '1900-01-01' ? $prospCliPot->cpc_fechademo = 'dd/mm/aaaa' : $prospCliPot->cpc_fechademo, ['class' =>'form-control']) !!}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-left">
                                                ...
                                                <div class="col-lg-7">
                                                    {!! Form::select('cpc_fechaimplemen',  array('1990' => '-', '2015' => '2015', '2016' => '2016', '2017' => '2017'),$prospCliPot->cpc_fechaimplemen, ['class' => 'form-control']) !!}
                                                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-lg-7">
                                                    {!! Form::date('cpc_feccierre', $prospCliPot->cpc_feccierre == '1900-01-01' ? $prospCliPot->cpc_feccierre = 'dd/mm/aaaa' : $prospCliPot->cpc_feccierre, ['class' =>'form-control']) !!}
                                                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-lg-7">
                                                    {!! Form::date('cpc_fechareact', $prospCliPot->cpc_fechareact == '1900-01-01' ? $prospCliPot->cpc_fechareact = 'dd/mm/aaaa' : $prospCliPot->cpc_fechareact, ['class' =>'form-control']) !!}
                                                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-lg-7">
                                                    {!! Form::date('cpp_fechafac', $prospCliPot->cpp_fechafac == '1900-01-01' ? $prospCliPot->cpp_fechafac = 'dd/mm/aaaa' : $prospCliPot->cpp_fechafac, ['class' =>'form-control','id' => 'fechafac']) !!}
                                                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-lg-7">
                                                    {{--{!! Form::date('cpc_fecha', $prospCliPot->cpc_fecha == '1900-01-01' ? $prospCliPot->cpc_fecha = 'dd/mm/aaaa' : $prospCliPot->cpc_fecha, ['class' =>'form-control','min' => \Carbon\Carbon::yesterday()->toDateString(), 'max' => \Carbon\Carbon::now()->toDateString()]) !!}--}}
                                                    {!! Form::date('cpc_fecha', $prospCliPot->cpc_fecha == '1900-01-01' ? $prospCliPot->cpc_fecha = 'dd/mm/aaaa' : $prospCliPot->cpc_fecha, ['class' =>'form-control']) !!}
                                                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group has-feedback">
                                                ...
                                                <div class="col-lg-7">
                                                    {!! Form::date('cpc_fechaplanifica', $prospCliPot->cpc_fechaplanifica, ['class' =>'form-control']) !!}
                                                    <span class="glyphicon glyphicon-calendar form-control-feedback"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('cpc_vendedor', $vendedores, null, ['class' => 'form-control']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <a class="btn btn-small btn-primary" data-toggle="modal" data-target="#exampleModal"
                                                       data-whatever="{{$prospCliPot->cpp_codigo}}">Ver Archivos Adjuntos</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-11">
                                                    {!! Form::text('cpc_motivo', '', ['class' => 'form-control','placeholder' => 'Motivo Contacto']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-11">
                                                    {!! Form::textarea('cpc_detallecont', '', ['class' => 'form-control', 'rows' => 3,'placeholder' => 'Detalle Contacto']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('cpcp_usuarioprox', null, ['class' => 'form-control','placeholder' => 'Usuario Próximo Contacto']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-11">
                                                    {!! Form::textarea('cpcp_detalleprox', '', ['class' => 'form-control', 'rows' => 3,'placeholder' => 'Detalle Próximo Contacto']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
