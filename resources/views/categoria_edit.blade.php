        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="col-lg-4">
                        {!! Form::model($categoria,['method' => 'PATCH','route'=>['categoria.update',$categoria->cate_codigo]]) !!}
                        {{--<form class="form-horizontal" role="form">--}}
                        <h3 class="form-section">Editar Categoría</h3>
                        ...
                        <div class="modal-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn btn-primary" href='{{URL::to('/categoria/create)}}'>Cancelar</a>
                                </div>
                            </div>
                        </div>
